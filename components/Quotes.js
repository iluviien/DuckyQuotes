...
export default function Quotes() {
  ...
  return (
    <View style={styles.container}>
      <CustomText style={styles.text}>{randomQuote}</CustomText>
      <Button style={styles.buttonStyle} onPress={generateRandomQuote}>
        <Text style={styles.buttonText}>Give me wisdom</Text>
      </Button>
    </View>
  );
}
